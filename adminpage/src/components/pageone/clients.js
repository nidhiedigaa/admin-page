...
function Clients(props)
{
    return(<>
      <Table>
        <thead>
          <tr>
          <td colspan={5} className="p-3">Clients</td>
          </tr>
        </thead>
        <tbody>
            <tr >
  ...
  <button class="btn btn-outline-secondary dropdown-toggle px-3 py-0" type="button" data-bs-toggle="dropdown" aria-expanded="false" style={{borderRadius:"20px"}}>
    Active
  </button>
